...
const samplePlayers = [
  ...
  { id: 'p1', name: 'Auston Matthews', teamId: 'tor', position: 'C' as const, jerseyNumber: 34, goals: 69, assists: 38, points: 107, plusMinus: 20, status: 'healthy' as const },
  { id: 'p2', name: 'David Pastrnak', teamId: 'bos', position: 'RW' as const, jerseyNumber: 10, goals: 47, assists: 63, points: 110, plusMinus: 10, status: 'healthy' as const },
  { id: 'p3', name: 'Nathan MacKinnon', teamId: 'col', position: 'C' as const, jerseyNumber: 29, goals: 51, assists: 89, points: 140, plusMinus: 15, status: 'healthy' as const },
  { id: 'p4', name: 'Leon Draisaitl', teamId: 'edm', position: 'C' as const, jerseyNumber: 29, goals: 41, assists: 65, points: 106, plusMinus: 5, status: 'healthy' as const },
  { id: 'p5', name: 'Nikita Kucherov', teamId: 'tbl', position: 'RW' as const, jerseyNumber: 86, goals: 44, assists: 100, points: 144, plusMinus: 8, status: 'healthy' as const },
  { id: 'p6', name: 'Elias Pettersson', teamId: 'van', position: 'C' as const, jerseyNumber: 40, goals: 34, assists: 55, points: 89, plusMinus: 12, status: 'questionable' as const },
  { id: 'p7', name: 'Artemi Panarin', teamId: 'nyr', position: 'LW' as const, jerseyNumber: 10, goals: 49, assists: 71, points: 120, plusMinus: 18, status: 'healthy' as const },
  { id: 'p8', name: 'Jason Robertson', teamId: 'dal', position: 'LW' as const, jerseyNumber: 21, goals: 29, assists: 51, points: 80, plusMinus: -5, status: 'injured' as const },
  // Defensemen
  { id: 'p9', name: 'Cale Makar', teamId: 'col', position: 'D' as const, jerseyNumber: 8, goals: 21, assists: 69, points: 90, plusMinus: 30, status: 'healthy' as const },
  { id: 'p10', name: 'Victor Hedman', teamId: 'tbl', position: 'D' as const, jerseyNumber: 77, goals: 13, assists: 63, points: 76, plusMinus: 10, status: 'healthy' as const },
  { id: 'p11', name: 'Quinn Hughes', teamId: 'van', position: 'D' as const, jerseyNumber: 43, goals: 17, assists: 75, points: 92, plusMinus: 38, status: 'healthy' as const },
  // Goalies
  { id: 'p12', name: 'Igor Shesterkin', teamId: 'nyr', position: 'G' as const, jerseyNumber: 31, wins: 36, losses: 17, shutouts: 4, savePercentage: 912, status: 'healthy' as const },
  { id: 'p13', name: 'Jeremy Swayman', teamId: 'bos', position: 'G' as const, jerseyNumber: 1, wins: 25, losses: 10, shutouts: 3, savePercentage: 916, status: 'healthy' as const },
  { id: 'p14', name: 'Jake Oettinger', teamId: 'dal', position: 'G' as const, jerseyNumber: 29, wins: 35, losses: 14, shutouts: 5, savePercentage: 905, status: 'questionable' as const },
];
