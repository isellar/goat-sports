...
import { BarChart3, CalendarClock, Trophy, Users, ArrowRight, TrendingUp, ShieldAlert, BellRing } from 'lucide-react';
  ...
  return (
    <div className="space-y-8">
      <div className="flex flex-col gap-2">
        <span className="text-sm font-medium text-hockey-blue">League Dashboard</span>
        ...
        <p className="text-hockey-light-slate max-w-2xl">
          Welcome to your fantasy hockey league dashboard. View your team stats, upcoming matchups, and league standings.
        </p>
      </div>
          ...
          >
            <div className="flex flex-col sm:flex-row justify-between items-center gap-6 p-3">
              <div className="flex flex-col items-center text-center">
                ...
                <h4 className="font-semibold text-hockey-slate">Ice Crushers</h4>
                <p className="text-sm text-hockey-light-slate">Your Team</p>
                <div className="mt-2 text-2xl font-bold text-hockey-slate">126</div>
              </div>
              
              <div className="flex flex-col items-center">
                <div className="text-hockey-blue font-semibold mb-1">Week 12</div>
                <div className="text-xs text-hockey-light-slate mb-3">Dec 4 - Dec 10</div>
              ...
              <div className="flex flex-col items-center text-center">
                ...
                <h4 className="font-semibold text-hockey-slate">Frozen Blades</h4>
                <p className="text-sm text-hockey-light-slate">John's Team</p>
                <div className="mt-2 text-2xl font-bold text-hockey-slate">98</div>
              </div>
            </div>
            ...
            <div className="space-y-3">
              <div className="p-3 rounded-lg border border-slate-200 bg-white">
                <div className="flex justify-between items-center">
                  ...
                  <div className="text-xs text-hockey-light-slate">Dec 11 - Dec 17</div>
                </div>
              ...
              <div className="p-3 rounded-lg border border-slate-200 bg-white">
                <div className="flex justify-between items-center">
                  ...
                  <div className="text-xs text-hockey-light-slate">Dec 18 - Dec 24</div>
                </div>
                <div className="mt-2 flex items-center gap-2">
                  <span className="font-medium text-hockey-slate">vs</span>
                  <div className="flex items-center">
                    <div className="w-6 h-6 rounded-full bg-purple-500 flex items-center justify-center text-white text-xs font-bold">K</div>
              ...
              <div className="p-3 rounded-lg border border-slate-200 bg-white">
                <div className="flex justify-between items-center">
                  ...
                  <div className="text-xs text-hockey-light-slate">Dec 25 - Dec 31</div>
                </div>
                <div className="mt-2 flex items-center gap-2">
                  <span className="font-medium text-hockey-slate">vs</span>
                  <div className="flex items-center">
            ...
            <div className="space-y-3">
              <div className="p-3 rounded-lg border border-slate-200 bg-white">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <div className="font-medium text-hockey-slate">Victor Hedman (D) - Questionable</div>
                    <div className="text-sm text-hockey-light-slate">May not play against NYR due to lower body injury</div>
                    <div className="text-xs text-hockey-light-slate mt-1">2 hours ago</div>
                  </div>
                </div>
              </div>
              ...
              <div className="p-3 rounded-lg border border-slate-200 bg-white">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <div className="font-medium text-hockey-slate">League Rankings Updated</div>
                    <div className="text-sm text-hockey-light-slate">Your team moved up 2 spots to 3rd place</div>
                    <div className="text-xs text-hockey-light-slate mt-1">Yesterday</div>
                  </div>
                </div>
              </div>
            </div>
