      ...
      <div className="container h-full mx-auto px-4 md:px-6 flex items-center justify-between">
        <div className="flex items-center">
          <NavLink to="/" className="flex items-center gap-2">
            ...
            <span className="text-xl font-display font-semibold text-hockey-slate dark:text-white">FantasyHockey</span>
          </NavLink>
        </div>
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="md:hidden flex items-center">
            ...
            <button className="p-2 rounded-full hover:bg-slate-100 dark:hover:bg-hockey-slate/60">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-hockey-slate dark:text-hockey-ice">
